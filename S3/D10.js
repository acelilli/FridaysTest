...
*/
me['skills'] = ["HTML", "CSS", "Javascript Basic"];
console.log(me)

/* ESERCIZIO F
  Crea un pezzo di codice per aggiungere un nuovo elemento all'array "skills" contenuto nell'oggetto "me".
*/
me.skills.push('Photoshop')
console.log(me)
...
function dice() {
  ...
  document.getElementById('dice').innerHTML = "Risultato del dado " + dice() // stampato il risultato direttamente sulla pagina html
...
if (boolean === true) {
  document.getElementById('ese4').innerHTML = string.slice(1); //levo solo la C
} else {
  document.getElementById('ese4').innerHTML = string.slice(0, -1); // con solo "-1" il risultato sarebbe solo la i
}
}
// deleteOne("Ciao a tutti", true)  //esempio true
deleteOne("Ciao a tutti", false)
...
console.log(onlyLetters("3 tigri contro 3 trigri"))
...
console.log(isThisAnEmail('esercizio6@mail.com'))
console.log(isThisAnEmail('FenicotteriRosa.it'))
...
const howManyDays = function (data) {
  ...
  const differenceDays = (today.getTime() - newDate.getTime() / (1000 * 3600 * 24));
  return differenceDays;
} /*
// mi sono persa cosa scrivere in console / stampare
document.getElementById('intervalloGiorni').innerHTML = data(1993/12/12).howManyDays(); // errore in console (sia se scrivo data che newDate)
*/
...
const countMovies = function() {
  ...
  document.getElementById("contaFilm").innerHTML = length
}
countMovies()
...
const onlyTheYears = function() {
  ...
  document.getElementById("soloAnni").innerHTML = 
} */
